...
//initializes user inputted values
int user_Dist = 500;
int user_Month = 1;
int user_Year = 1990;
...
//this function should create the graph for the given airport code, distance, date range, and passangers
...
//used for drawing everything that is manual to the screen
void MainWindow::paintEvent(QPaintEvent *event){
    ...
    //adjusts for where the usa map is dispalyed
